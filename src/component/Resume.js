          ...
          <div className="parentdivflexy flex flex-row w-full">
            <div className="flex flex-col w-1/3">
              <div className="resume-section">
                <h3 className="semi">
                  <strong><i class="ri-user-2-fill"></i> &nbsp;&nbsp;Personal Information:</strong>
                </h3>
                <p className="semi" >
                  <strong>
            ...
            <div className="Section-two flex flex-col w-2/3">
              <div className="resume-section">
                <h3 className="semi">
                  <strong><i class="ri-profile-line"></i> &nbsp;&nbsp;Professional Summary:</strong>
                </h3>
              ...
              <div className="resume-section">
                <h2 className="semi">
                  <strong><i class="ri-add-fill"></i> &nbsp; Additional Information:</strong>
                </h2>
                <p className="semi">
